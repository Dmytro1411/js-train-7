...
log("Завдання 1 ====================================");
log(createSymbol()); // Виведе Symbol()
...
log("Завдання 2 ====================================");
log(createSymbolWithDescription("My symbol")); // Виведе My symbol
...
log("Завдання 3 ====================================");
log(createSymbolProperty("Це властивість об'єкту з використанням символу")); //Виведе { [Symbol()]: "Це властивість об'єкту з використанням символу" }
...
function createAndCompareTwoSymbols(value) {
  ...
  const key1 = Symbol(value);
  //   log(key1);
  const key2 = Symbol(value);
  //   log(key2);
...
log(createAndCompareTwoSymbols("My Symbol")); // Виведе false
...
log(compareSymbolsForKey(symbol5, symbol6)); //Виведе: true

log("Завдання 6 ====================================");
let symbolForKey = Symbol.for("myKey"); // Створюємо новий символ або отримуємо існуючий з глобального реєстру символів
log(getSymbolKey(symbolForKey)); // Виводимо ключ символу. Виведе: myKey
...
log("Завдання 7 ====================================");
log(useSymbolToStringTag()); //Виведе CustomObject
...
log("Завдання 8 ====================================");
log(useSymbolDescription()); //Виведе mySymbol
...
log("Завдання 9 ====================================");
log(useSymbolIterator(rangeObject)); //Виведе [ 1, 2, 3, 4, 5, 6 ]
...
//   function addDatePhoneBook(myKey, personData) {
//     let symbolKey = Symbol(person);
//     phoneBook[Symbol(person)] = { name: "John", phone: "555-1234" };
//     log(myKey);
//     log(symbolKey);
...
//     phone: "777-666",
//   };
//   let symbolKey = addDatePhoneBook("person", person);
//   //   log(phoneBook[symbolKey]);
// }
